...
class StructureDefinitionTests(unittest.TestCase):
    ...
    def implStructureDefinition1(self, inst):
        ...
        self.assertEqual(inst.differential.element[0].id.value, FHIRString("Composition").value)
        self.assertEqual(inst.differential.element[0].id.as_json(), "Composition")
        ...
        self.assertEqual(inst.differential.element[1].id.value, FHIRString("Composition.section").value)
        self.assertEqual(inst.differential.element[1].id.as_json(), "Composition.section")
        ...
        self.assertEqual(inst.differential.element[2].id.value, FHIRString("Composition.section:procedure").value)
        self.assertEqual(inst.differential.element[2].id.as_json(), "Composition.section:procedure")
        ...
        self.assertEqual(inst.differential.element[3].id.value, FHIRString("Composition.section:medications").value)
        self.assertEqual(inst.differential.element[3].id.as_json(), "Composition.section:medications")
        ...
        self.assertEqual(inst.differential.element[4].id.value, FHIRString("Composition.section:plan").value)
        self.assertEqual(inst.differential.element[4].id.as_json(), "Composition.section:plan")
        ...
        self.assertEqual(inst.id.value, FHIRString("example-composition").value)
        self.assertEqual(inst.id.as_json(), "example-composition")
    ...
    def implStructureDefinition2(self, inst):
        ...
        self.assertEqual(inst.differential.element[3].id.value, FHIRString("Composition.section:procedure.title").value)
        self.assertEqual(inst.differential.element[3].id.as_json(), "Composition.section:procedure.title")
        self.assertEqual(inst.differential.element[3].min.value, FHIRUnsignedInt('1').value)
        self.assertEqual(inst.differential.element[3].min.as_json(), 1)
        ...
        self.assertEqual(inst.differential.element[4].id.value, FHIRString("Composition.section:procedure.code").value)
        self.assertEqual(inst.differential.element[4].id.as_json(), "Composition.section:procedure.code")
        ...
        self.assertEqual(inst.differential.element[5].id.value, FHIRString("Composition.section:medications").value)
        self.assertEqual(inst.differential.element[5].id.as_json(), "Composition.section:medications")
        ...
        self.assertEqual(inst.differential.element[6].id.value, FHIRString("Composition.section:medications.title").value)
        self.assertEqual(inst.differential.element[6].id.as_json(), "Composition.section:medications.title")
        ...
        self.assertEqual(inst.differential.element[7].id.value, FHIRString("Composition.section:medications.code").value)
        self.assertEqual(inst.differential.element[7].id.as_json(), "Composition.section:medications.code")
        ...
        self.assertEqual(inst.differential.element[8].id.value, FHIRString("Composition.section:plan").value)
        self.assertEqual(inst.differential.element[8].id.as_json(), "Composition.section:plan")
        ...
        self.assertEqual(inst.differential.element[9].id.value, FHIRString("Composition.section:plan.title").value)
        self.assertEqual(inst.differential.element[9].id.as_json(), "Composition.section:plan.title")
        ...
        self.assertFalse(inst.experimental)
        self.assertEqual(inst.id.value, FHIRString("example-section-library").value)
        self.assertEqual(inst.id.as_json(), "example-section-library")
        self.assertEqual(inst.kind.value, FHIRCode("complex-type").value)
        self.assertEqual(inst.kind.as_json(), "complex-type")
