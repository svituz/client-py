...
class ServiceRequestTests(unittest.TestCase):
    ...
    def implServiceRequest2(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("myringotomy").value)
        self.assertEqual(inst.id.as_json(), "myringotomy")
    ...
    def implServiceRequest3(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("do-not-turn").value)
        self.assertEqual(inst.id.as_json(), "do-not-turn")
    ...
    def implServiceRequest4(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("physical-therapy").value)
        self.assertEqual(inst.id.as_json(), "physical-therapy")
        self.assertEqual(inst.intent.value, FHIRCode("order").value)
        self.assertEqual(inst.intent.as_json(), "order")
        self.assertEqual(inst.meta.tag[0].code.value, FHIRCode("HTEST").value)
        self.assertEqual(inst.meta.tag[0].code.as_json(), "HTEST")
    ...
    def implServiceRequest5(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("colon-biopsy").value)
        self.assertEqual(inst.id.as_json(), "colon-biopsy")
    ...
    def implServiceRequest6(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("appendectomy-narrative").value)
        self.assertEqual(inst.id.as_json(), "appendectomy-narrative")
        self.assertEqual(inst.intent.value, FHIRCode("order").value)
        self.assertEqual(inst.intent.as_json(), "order")
        self.assertEqual(inst.meta.tag[0].code.value, FHIRCode("HTEST").value)
        self.assertEqual(inst.meta.tag[0].code.as_json(), "HTEST")
    ...
    def implServiceRequest7(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("og-example1").value)
        self.assertEqual(inst.id.as_json(), "og-example1")
    ...
    def implServiceRequest8(self, inst):
        ...
        self.assertEqual(inst.contained[0].id.value, FHIRString("fasting").value)
        self.assertEqual(inst.contained[0].id.as_json(), "fasting")
        self.assertEqual(inst.contained[1].id.value, FHIRString("serum").value)
        self.assertEqual(inst.contained[1].id.as_json(), "serum")
        self.assertEqual(inst.id.value, FHIRString("lipid").value)
        self.assertEqual(inst.id.as_json(), "lipid")
    ...
    def implServiceRequest9(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("ob").value)
        self.assertEqual(inst.id.as_json(), "ob")
        self.assertEqual(inst.intent.value, FHIRCode("order").value)
        self.assertEqual(inst.intent.as_json(), "order")
        self.assertEqual(inst.meta.tag[0].code.value, FHIRCode("HTEST").value)
        self.assertEqual(inst.meta.tag[0].code.as_json(), "HTEST")
    ...
    def implServiceRequest10(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("di").value)
        self.assertEqual(inst.id.as_json(), "di")
        self.assertEqual(inst.intent.value, FHIRCode("original-order").value)
        self.assertEqual(inst.intent.as_json(), "original-order")
        self.assertEqual(inst.meta.tag[0].code.value, FHIRCode("HTEST").value)
        self.assertEqual(inst.meta.tag[0].code.as_json(), "HTEST")
