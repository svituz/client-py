...
class RelatedPersonTests(unittest.TestCase):
    ...
    def implRelatedPerson1(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("newborn-mom").value)
        self.assertEqual(inst.id.as_json(), "newborn-mom")
    ...
    def implRelatedPerson3(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("peter").value)
        self.assertEqual(inst.id.as_json(), "peter")
        self.assertEqual(inst.meta.tag[0].code.value, FHIRCode("HTEST").value)
        self.assertEqual(inst.meta.tag[0].code.as_json(), "HTEST")
        self.assertEqual(inst.meta.tag[0].display.value, FHIRString("test health data").value)
        self.assertEqual(inst.meta.tag[0].display.as_json(), "test health data")
    ...
    def implRelatedPerson5(self, inst):
        ...
        self.assertEqual(inst.gender.value, FHIRCode("female").value)
        self.assertEqual(inst.gender.as_json(), "female")
        self.assertEqual(inst.id.value, FHIRString("benedicte").value)
        self.assertEqual(inst.id.as_json(), "benedicte")
