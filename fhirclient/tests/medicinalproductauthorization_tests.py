...
class MedicinalProductAuthorizationTests(unittest.TestCase):
    ...
    def implMedicinalProductAuthorization1(self, inst):
        ...
        self.assertEqual(inst.jurisdictionalAuthorization[0].id.value, FHIRString("1").value)
        self.assertEqual(inst.jurisdictionalAuthorization[0].id.as_json(), "1")
        ...
        self.assertEqual(inst.jurisdictionalAuthorization[1].id.value, FHIRString("2").value)
        self.assertEqual(inst.jurisdictionalAuthorization[1].id.as_json(), "2")
