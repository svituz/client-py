...
class GroupTests(unittest.TestCase):
    ...
    def implGroup1(self, inst):
        ...
        self.assertEqual(inst.extension[0].url.value, FHIRUri("http://example.org/fhir/StructureDefinition/owner").value)
        self.assertEqual(inst.extension[0].url.as_json(), "http://example.org/fhir/StructureDefinition/owner")
        self.assertEqual(inst.id.value, FHIRString("herd1").value)
        self.assertEqual(inst.id.as_json(), "herd1")
    ...
    def implGroup4(self, inst):
        ...
        self.assertFalse(inst.characteristic[0].exclude)
        self.assertEqual(inst.id.value, FHIRString("example-patientlist").value)
        self.assertEqual(inst.id.as_json(), "example-patientlist")
        self.assertEqual(inst.meta.tag[0].code.value, FHIRCode("HTEST").value)
        self.assertEqual(inst.meta.tag[0].code.as_json(), "HTEST")
        self.assertEqual(inst.meta.tag[0].display.value, FHIRString("test health data").value)
        self.assertEqual(inst.meta.tag[0].display.as_json(), "test health data")
