...
class CommunicationRequestTests(unittest.TestCase):
    ...
    def implCommunicationRequest1(self, inst):
        ...
        self.assertEqual(inst.contained[0].id.value, FHIRString("provider").value)
        self.assertEqual(inst.contained[0].id.as_json(), "provider")
        self.assertEqual(inst.contained[1].id.value, FHIRString("payor").value)
        self.assertEqual(inst.contained[1].id.as_json(), "payor")
        self.assertEqual(inst.contained[2].id.value, FHIRString("requester").value)
        self.assertEqual(inst.contained[2].id.as_json(), "requester")
        ...
        self.assertEqual(inst.id.value, FHIRString("fm-solicit").value)
        self.assertEqual(inst.id.as_json(), "fm-solicit")
