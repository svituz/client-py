...
class ProcedureTests(unittest.TestCase):
    ...
    def implProcedure2(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("ambulation").value)
        self.assertEqual(inst.id.as_json(), "ambulation")
    ...
    def implProcedure3(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("example-implant").value)
        self.assertEqual(inst.id.as_json(), "example-implant")
        self.assertEqual(inst.meta.tag[0].code.value, FHIRCode("HTEST").value)
        self.assertEqual(inst.meta.tag[0].code.as_json(), "HTEST")
        self.assertEqual(inst.meta.tag[0].display.value, FHIRString("test health data").value)
        self.assertEqual(inst.meta.tag[0].display.as_json(), "test health data")
    ...
    def implProcedure4(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("biopsy").value)
        self.assertEqual(inst.id.as_json(), "biopsy")
        self.assertEqual(inst.meta.tag[0].code.value, FHIRCode("HTEST").value)
        self.assertEqual(inst.meta.tag[0].code.as_json(), "HTEST")
        self.assertEqual(inst.meta.tag[0].display.value, FHIRString("test health data").value)
        self.assertEqual(inst.meta.tag[0].display.as_json(), "test health data")
    ...
    def implProcedure5(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("colonoscopy").value)
        self.assertEqual(inst.id.as_json(), "colonoscopy")
        self.assertEqual(inst.identifier[0].value.value, FHIRString("12345").value)
        self.assertEqual(inst.identifier[0].value.as_json(), "12345")
        self.assertEqual(inst.meta.tag[0].code.value, FHIRCode("HTEST").value)
        self.assertEqual(inst.meta.tag[0].code.as_json(), "HTEST")
    ...
    def implProcedure6(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("education").value)
        self.assertEqual(inst.id.as_json(), "education")
        self.assertEqual(inst.meta.tag[0].code.value, FHIRCode("HTEST").value)
        self.assertEqual(inst.meta.tag[0].code.as_json(), "HTEST")
        self.assertEqual(inst.meta.tag[0].display.value, FHIRString("test health data").value)
        self.assertEqual(inst.meta.tag[0].display.as_json(), "test health data")
...
from fhirclient.models.fhirdatatypes import FHIRString, FHIRCode, FHIRUri, FHIRMarkdown, FHIRDateTime, FHIRCanonical