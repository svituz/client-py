...
class BasicTests(unittest.TestCase):
    ...
    def implBasic1(self, inst):
        ...
        self.assertEqual(inst.extension[0].url.value, FHIRUri("http://example.org/do-not-use/fhir-extensions/referral#requestingPractitioner").value)
        self.assertEqual(inst.extension[0].url.as_json(), "http://example.org/do-not-use/fhir-extensions/referral#requestingPractitioner")
        self.assertEqual(inst.extension[1].url.value, FHIRUri("http://example.org/do-not-use/fhir-extensions/referral#notes").value)
        self.assertEqual(inst.extension[1].url.as_json(), "http://example.org/do-not-use/fhir-extensions/referral#notes")
        ...
        self.assertEqual(inst.extension[2].url.value, FHIRUri("http://example.org/do-not-use/fhir-extensions/referral#fulfillingEncounter").value)
        self.assertEqual(inst.extension[2].url.as_json(), "http://example.org/do-not-use/fhir-extensions/referral#fulfillingEncounter")
        self.assertEqual(inst.id.value, FHIRString("referral").value)
        self.assertEqual(inst.id.as_json(), "referral")
        ...
        self.assertEqual(inst.modifierExtension[0].url.value, FHIRUri("http://example.org/do-not-use/fhir-extensions/referral#referredForService").value)
        self.assertEqual(inst.modifierExtension[0].url.as_json(), "http://example.org/do-not-use/fhir-extensions/referral#referredForService")
        ...
        self.assertEqual(inst.modifierExtension[1].url.value, FHIRUri("http://example.org/do-not-use/fhir-extensions/referral#targetDate").value)
        self.assertEqual(inst.modifierExtension[1].url.as_json(), "http://example.org/do-not-use/fhir-extensions/referral#targetDate")
        ...
        self.assertEqual(inst.modifierExtension[2].url.value, FHIRUri("http://example.org/do-not-use/fhir-extensions/referral#status").value)
        self.assertEqual(inst.modifierExtension[2].url.as_json(), "http://example.org/do-not-use/fhir-extensions/referral#status")
    ...
    def implBasic2(self, inst):
        ...
        self.assertEqual(inst.extension[0].extension[0].url.value, FHIRUri("name").value)
        self.assertEqual(inst.extension[0].extension[0].url.as_json(), "name")
        ...
        self.assertEqual(inst.extension[0].extension[1].extension[0].url.value, FHIRUri("name").value)
        self.assertEqual(inst.extension[0].extension[1].extension[0].url.as_json(), "name")
        ...
        self.assertEqual(inst.extension[0].extension[1].extension[1].url.value, FHIRUri("minOccurs").value)
        self.assertEqual(inst.extension[0].extension[1].extension[1].url.as_json(), "minOccurs")
        self.assertEqual(inst.extension[0].extension[1].extension[1].valueInteger, 1)
        self.assertEqual(inst.extension[0].extension[1].extension[2].url.value, FHIRUri("maxOccurs").value)
        self.assertEqual(inst.extension[0].extension[1].extension[2].url.as_json(), "maxOccurs")
        ...
        self.assertEqual(inst.extension[0].extension[1].url.value, FHIRUri("attribute").value)
        self.assertEqual(inst.extension[0].extension[1].url.as_json(), "attribute")
        self.assertEqual(inst.extension[0].extension[2].extension[0].url.value, FHIRUri("name").value)
        self.assertEqual(inst.extension[0].extension[2].extension[0].url.as_json(), "name")
        ...
        self.assertEqual(inst.extension[0].extension[2].extension[1].url.value, FHIRUri("minOccurs").value)
        self.assertEqual(inst.extension[0].extension[2].extension[1].url.as_json(), "minOccurs")
        self.assertEqual(inst.extension[0].extension[2].extension[1].valueInteger, 0)
        self.assertEqual(inst.extension[0].extension[2].extension[2].url.value, FHIRUri("maxOccurs").value)
        self.assertEqual(inst.extension[0].extension[2].extension[2].url.as_json(), "maxOccurs")
        self.assertEqual(inst.extension[0].extension[2].extension[2].valueInteger, 1)
        self.assertEqual(inst.extension[0].extension[2].url.value, FHIRUri("attribute").value)
        self.assertEqual(inst.extension[0].extension[2].url.as_json(), "attribute")
        self.assertEqual(inst.extension[0].url.value, FHIRUri("http://example.org/do-not-use/fhir-extensions/UMLclass").value)
        self.assertEqual(inst.extension[0].url.as_json(), "http://example.org/do-not-use/fhir-extensions/UMLclass")
        self.assertEqual(inst.id.value, FHIRString("classModel").value)
        self.assertEqual(inst.id.as_json(), "classModel")
        self.assertEqual(inst.meta.tag[0].code.value, FHIRCode("HTEST").value)
        self.assertEqual(inst.meta.tag[0].code.as_json(), "HTEST")
        self.assertEqual(inst.meta.tag[0].display.value, FHIRString("test health data").value)
        self.assertEqual(inst.meta.tag[0].display.as_json(), "test health data")
    ...
    def implBasic3(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("basic-example-narrative").value)
        self.assertEqual(inst.id.as_json(), "basic-example-narrative")
        self.assertEqual(inst.meta.tag[0].code.value, FHIRCode("HTEST").value)
        self.assertEqual(inst.meta.tag[0].code.as_json(), "HTEST")
        self.assertEqual(inst.meta.tag[0].display.value, FHIRString("test health data").value)
        self.assertEqual(inst.meta.tag[0].display.as_json(), "test health data")
