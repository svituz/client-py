...
class ClaimTests(unittest.TestCase):
    ...
    def implClaim1(self, inst):
        ...
        self.assertEqual(inst.contained[0].id.value, FHIRString("patient-1").value)
        self.assertEqual(inst.contained[0].id.as_json(), "patient-1")
        ...
        self.assertEqual(inst.id.value, FHIRString("100155").value)
        self.assertEqual(inst.id.as_json(), "100155")
    ...
    def implClaim2(self, inst):
        self.assertEqual(inst.careTeam[0].sequence.value, FHIRPositiveInt('1').value)
        self.assertEqual(inst.careTeam[0].sequence.as_json(), 1)
        self.assertEqual(inst.contained[0].id.value, FHIRString("org-insurer").value)
        self.assertEqual(inst.contained[0].id.as_json(), "org-insurer")
        self.assertEqual(inst.contained[1].id.value, FHIRString("org-org").value)
        self.assertEqual(inst.contained[1].id.as_json(), "org-org")
        self.assertEqual(inst.contained[2].id.value, FHIRString("provider-1").value)
        self.assertEqual(inst.contained[2].id.as_json(), "provider-1")
        self.assertEqual(inst.contained[3].id.value, FHIRString("patient-1").value)
        self.assertEqual(inst.contained[3].id.as_json(), "patient-1")
        self.assertEqual(inst.contained[4].id.value, FHIRString("coverage-1").value)
        self.assertEqual(inst.contained[4].id.as_json(), "coverage-1")
        self.assertEqual(inst.created.value, FHIRDateTime("2014-08-16").value)
        self.assertEqual(inst.created.as_json(), "2014-08-16")
        self.assertEqual(inst.diagnosis[0].diagnosisCodeableConcept.coding[0].code.value, FHIRCode("123456").value)
        self.assertEqual(inst.diagnosis[0].diagnosisCodeableConcept.coding[0].code.as_json(), "123456")
        self.assertEqual(inst.diagnosis[0].sequence.value, FHIRPositiveInt('1').value)
        self.assertEqual(inst.diagnosis[0].sequence.as_json(), 1)
        self.assertEqual(inst.id.value, FHIRString("100152").value)
        self.assertEqual(inst.id.as_json(), "100152")
        self.assertEqual(inst.identifier[0].system.value, FHIRUri("http://happyvalley.com/claim").value)
        self.assertEqual(inst.identifier[0].system.as_json(), "http://happyvalley.com/claim")
        self.assertEqual(inst.identifier[0].value.value, FHIRString("12347").value)
        self.assertEqual(inst.identifier[0].value.as_json(), "12347")
    ...
    def implClaim3(self, inst):
        self.assertEqual(inst.careTeam[0].sequence.value, FHIRPositiveInt('1').value)
        self.assertEqual(inst.careTeam[0].sequence.as_json(), 1)
        self.assertEqual(inst.contained[0].id.value, FHIRString("device-frame").value)
        self.assertEqual(inst.contained[0].id.as_json(), "device-frame")
        self.assertEqual(inst.contained[1].id.value, FHIRString("device-lens").value)
        self.assertEqual(inst.contained[1].id.as_json(), "device-lens")
        self.assertEqual(inst.created.value, FHIRDateTime("2014-08-16").value)
        self.assertEqual(inst.created.as_json(), "2014-08-16")
        ...
        self.assertEqual(inst.diagnosis[0].sequence.value, FHIRPositiveInt('1').value)
        self.assertEqual(inst.diagnosis[0].sequence.as_json(), 1)
        self.assertEqual(inst.id.value, FHIRString("660152").value)
        self.assertEqual(inst.id.as_json(), "660152")
    ...
    def implClaim4(self, inst):
        ...
        self.assertEqual(inst.diagnosis[0].sequence.value, FHIRPositiveInt('1').value)
        self.assertEqual(inst.diagnosis[0].sequence.as_json(), 1)
        self.assertEqual(inst.id.value, FHIRString("760151").value)
        self.assertEqual(inst.id.as_json(), "760151")
    ...
    def implClaim5(self, inst):
        ...
        self.assertEqual(inst.diagnosis[0].sequence.value, FHIRPositiveInt('1').value)
        self.assertEqual(inst.diagnosis[0].sequence.as_json(), 1)
        self.assertEqual(inst.id.value, FHIRString("860150").value)
        self.assertEqual(inst.id.as_json(), "860150")
    ...
    def implClaim6(self, inst):
        self.assertEqual(inst.careTeam[0].sequence.value, FHIRPositiveInt('1').value)
        self.assertEqual(inst.careTeam[0].sequence.as_json(), 1)
        self.assertEqual(inst.contained[0].id.value, FHIRString("device-bridge").value)
        self.assertEqual(inst.contained[0].id.as_json(), "device-bridge")
        self.assertEqual(inst.contained[1].id.value, FHIRString("referral").value)
        self.assertEqual(inst.contained[1].id.as_json(), "referral")
        self.assertEqual(inst.created.value, FHIRDateTime("2014-08-16").value)
        self.assertEqual(inst.created.as_json(), "2014-08-16")
        self.assertEqual(inst.id.value, FHIRString("100156").value)
        self.assertEqual(inst.id.as_json(), "100156")
        self.assertEqual(inst.identifier[0].system.value, FHIRUri("http://happyvalley.com/claim").value)
        self.assertEqual(inst.identifier[0].system.as_json(), "http://happyvalley.com/claim")
    ...
    def implClaim7(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("100153").value)
        self.assertEqual(inst.id.as_json(), "100153")
        self.assertEqual(inst.identifier[0].system.value, FHIRUri("http://happyvalley.com/claim").value)
        self.assertEqual(inst.identifier[0].system.as_json(), "http://happyvalley.com/claim")
    ...
    def implClaim8(self, inst):
        ...
        self.assertEqual(inst.diagnosis[0].sequence.value, FHIRPositiveInt('1').value)
        self.assertEqual(inst.diagnosis[0].sequence.as_json(), 1)
        self.assertEqual(inst.id.value, FHIRString("760152").value)
        self.assertEqual(inst.id.as_json(), "760152")
        self.assertEqual(inst.identifier[0].system.value, FHIRUri("http://happypharma.com/claim").value)
        self.assertEqual(inst.identifier[0].system.as_json(), "http://happypharma.com/claim")
        self.assertEqual(inst.identifier[0].value.value, FHIRString("7612345").value)
        self.assertEqual(inst.identifier[0].value.as_json(), "7612345")
    ...
    def implClaim9(self, inst):
        ...
        self.assertEqual(inst.diagnosis[0].sequence.value, FHIRPositiveInt('1').value)
        self.assertEqual(inst.diagnosis[0].sequence.as_json(), 1)
        self.assertEqual(inst.id.value, FHIRString("100151").value)
        self.assertEqual(inst.id.as_json(), "100151")
        self.assertEqual(inst.identifier[0].system.value, FHIRUri("http://happyvalley.com/claim").value)
        self.assertEqual(inst.identifier[0].system.as_json(), "http://happyvalley.com/claim")
    ...
    def implClaim10(self, inst):
        ...
        self.assertEqual(inst.diagnosis[0].sequence.value, FHIRPositiveInt('1').value)
        self.assertEqual(inst.diagnosis[0].sequence.as_json(), 1)
        self.assertEqual(inst.id.value, FHIRString("660151").value)
        self.assertEqual(inst.id.as_json(), "660151")
        self.assertEqual(inst.identifier[0].system.value, FHIRUri("http://happysight.com/claim").value)
        self.assertEqual(inst.identifier[0].system.as_json(), "http://happysight.com/claim")
...
from fhirclient.models.fhirdatatypes import FHIRPositiveInt, FHIRString, FHIRDateTime, FHIRCode, FHIRUri, FHIRDate