...
class FamilyMemberHistoryTests(unittest.TestCase):
    ...
    def implFamilyMemberHistory1(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("father").value)
        self.assertEqual(inst.id.as_json(), "father")
    ...
    def implFamilyMemberHistory2(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("mother").value)
        self.assertEqual(inst.id.as_json(), "mother")
        self.assertEqual(inst.meta.tag[0].code.value, FHIRCode("HTEST").value)
        self.assertEqual(inst.meta.tag[0].code.as_json(), "HTEST")
        self.assertEqual(inst.meta.tag[0].display.value, FHIRString("test health data").value)
        self.assertEqual(inst.meta.tag[0].display.as_json(), "test health data")
