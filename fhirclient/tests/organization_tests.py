...
class OrganizationTests(unittest.TestCase):
    ...
    def implOrganization1(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("mmanu").value)
        self.assertEqual(inst.id.as_json(), "mmanu")
    ...
    def implOrganization2(self, inst):
        self.assertEqual(inst.id.value, FHIRString("hl7pay").value)
        self.assertEqual(inst.id.as_json(), "hl7pay")
        self.assertEqual(inst.meta.tag[0].code.value, FHIRCode("HTEST").value)
        self.assertEqual(inst.meta.tag[0].code.as_json(), "HTEST")
        self.assertEqual(inst.meta.tag[0].display.value, FHIRString("test health data").value)
        self.assertEqual(inst.meta.tag[0].display.as_json(), "test health data")
    ...
    def implOrganization5(self, inst):
        self.assertEqual(inst.id.value, FHIRString("1832473e-2fe0-452d-abe9-3cdb9879522f").value)
        self.assertEqual(inst.id.as_json(), "1832473e-2fe0-452d-abe9-3cdb9879522f")
    ...
    def implOrganization6(self, inst):
        self.assertEqual(inst.id.value, FHIRString("2.16.840.1.113883.19.5").value)
        self.assertEqual(inst.id.as_json(), "2.16.840.1.113883.19.5")
