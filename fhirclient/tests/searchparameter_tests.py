...
class SearchParameterTests(unittest.TestCase):
    ...
    def implSearchParameter1(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("example-extension").value)
        self.assertEqual(inst.id.as_json(), "example-extension")
    ...
    def implSearchParameter2(self, inst):
        ...
        self.assertEqual(inst.id.value, FHIRString("example-reference").value)
        self.assertEqual(inst.id.as_json(), "example-reference")
