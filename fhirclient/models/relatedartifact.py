...
from fhirclient.datatypes.primitive import FHIRMarkdown, FHIRCode, FHIRString, FHIRCanonical, FHIRUrl
from . import element
...
class RelatedArtifact(element.Element):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("citation", "citation", FHIRMarkdown, False, None, False),
            ("display", "display", FHIRString, False, None, False),
            ("document", "document", attachment.Attachment, False, None, False),
            ("label", "label", FHIRString, False, None, False),
            ("resource", "resource", FHIRCanonical, False, None, False),
