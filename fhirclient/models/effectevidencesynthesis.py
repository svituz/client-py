...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/EffectEvidenceSynthesis) on 2020-03-26.
...
class EffectEvidenceSynthesisResultsByExposure(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("description", "description", fhirdatatypes.FHIRString, False, None, False),
            ("exposureState", "exposureState", fhirdatatypes.FHIRCode, False, None, False),
            ("variantState", "variantState", codeableconcept.CodeableConcept, False, None, False),
