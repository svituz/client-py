...
from fhirclient.datatypes.primitive import FHIRAbstractDatatype
...
class FHIRAbstractBase(object):
    ...
    #     """
    #     Override to return the value in case the accessed attribute is a FHIRAbstractDatatype
    #     """
    #     try:
    ...
    #         raise
    #     else:
    #         if isinstance(item, FHIRAbstractDatatype):
    #             return item.value
    #         return item
