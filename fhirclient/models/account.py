...
from fhirclient.datatypes.primitive import FHIRString, FHIRPositiveInt
...
class Account(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("status", "status", FHIRString, False, None, True),
...
class AccountCoverage(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("priority", "priority", FHIRPositiveInt, False, None, False),
        ])
        return js
